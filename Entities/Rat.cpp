...
void Rat::initAnimations()
{
    ...
    this->animationComponent->addAnimation("ATTACK",2.f,0,2,13,2,60,64);
}
...
void Rat::render(sf::RenderTarget& target, sf::Shader* shader, const sf::Vector2f light_position, const bool showHitbox)
{
    if (shader)
    {
